    ...
    return (
        <li>
            <button
                    ...
                    className="dropdown-button flex items-center justify-between w-full py-2 px-3 text-zinc-900 rounded hover:bg-zinc-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto dark:text-white md:dark:hover:text-blue-500 dark:focus:text-white dark:border-zinc-700 dark:hover:bg-zinc-700 md:dark:hover:bg-transparent">
                Dropdown
                <svg
            ...
            <div ref={dropDownRef}
                 className="dropdown-parent absolute z-50 font-normal bg-white divide-y divide-zinc-100 rounded-lg shadow w-44 dark:bg-zinc-700 dark:divide-zinc-600 hidden">
